...
public class RNSerialportModule extends ReactContextBaseJavaModule {
    ...
    public void onReceive(Context context, Intent intent) {
      ...
      switch (action) {
        ...
        case ACTION_USB_PERMISSION :
          ...
          /*WritableMap map = createError(666, "Acesso: "+granted);
  ...
  @ReactMethod
  public void readSync(Promise promise) {
    serialPort.syncOpen();
    ...
    String texto = new String(received);

    eventEmit(onErrorEvent, createError(500, texto));
  ...
  @ReactMethod
  public void liberarAcessoUSB() {
    PendingIntent mPendingIntent = PendingIntent.getBroadcast(reactContext, 0 , new Intent(ACTION_MANAGE_ALL_FILES_ACCESS_PERMISSION), PendingIntent.FLAG_UPDATE_CURRENT | PendingIntent.FLAG_MUTABLE);
 ...
 public void isServiceStarted(Promise promise) {
  ...
  public void writeString(String message) {
    ...
    WritableMap map = createError(666, "Mensagem: "+message);
    eventEmit(onErrorEvent, map);
  ...
  private void requestUserPermission() {
    if(device == null)
      return;
    PendingIntent mPendingIntent = PendingIntent.getBroadcast(reactContext, 0 , new Intent(ACTION_USB_PERMISSION), PendingIntent.FLAG_UPDATE_CURRENT | PendingIntent.FLAG_MUTABLE);
    usbManager.requestPermission(device, mPendingIntent);
  }
      ...
      try {
        ...
        if(returnedDataType == Definitions.RETURNED_DATA_TYPE_INTARRAY) {
          ...
          for(byte b: bytes) {
            ...
            content += UnsignedBytes.toInt(b) + "";
          }
          eventEmit(onErrorEvent, createError(1000, intArray.toString()));
          ...
          eventEmit(onErrorEvent, createError(1000, hexString));
